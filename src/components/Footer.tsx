        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/resources" className="text-white/80 hover:text-white transition-colors duration-200">
                  Resources
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/donate" className="text-white/80 hover:text-white transition-colors duration-200">
                  Donate
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/auth" className="text-white/80 hover:text-white transition-colors duration-200">
                  Get Help
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/blog" className="text-white/80 hover:text-white transition-colors duration-200">
                  Blog
                </Link>
              </li>
              <li>
