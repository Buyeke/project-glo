...
const HowGLOWorksModal = ({ trigger, defaultOpen = false }: HowGLOWorksModalProps) => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Based on your needs, we connect you with verified organizations—shelters, legal aid, counseling, and employment support.",
      icon: Users,
      details: [
    ...
    },
    {
      ...
      description: "Within 24 hours, a trained support worker from one of our partner organizations will reach out to help you directly.",
      icon: Phone,
      details: [
