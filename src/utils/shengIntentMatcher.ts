...
export const shengIntents: ShengIntent[] = [
  ...
  { sheng: "deadisha", meaning: "to kill", intent: "life-threatening violence", urgency: 'critical', category: 'emergency' },
  { sheng: "fyeka", meaning: "kill", intent: "life-threatening violence", urgency: 'critical', category: 'emergency' },
  { sheng: "murder", meaning: "kill", intent: "life-threatening violence", urgency: 'critical', category: 'emergency' },
  { sheng: "diambo", meaning: "trouble, danger, problem", intent: "dangerous situation", urgency: 'critical', category: 'emergency' },
  { sheng: "fiam", meaning: "danger", intent: "dangerous situation", urgency: 'critical', category: 'emergency' },
  { sheng: "dedi", meaning: "die or end", intent: "suicide crisis or danger", urgency: 'critical', category: 'mental_health' },
  { sheng: "dimbas", meaning: "trouble", intent: "serious problems", urgency: 'critical', category: 'emergency' },
  ...
  { sheng: "banwa", meaning: "caught/trapped/in trouble", intent: "being in crisis", urgency: 'high', category: 'emergency' },
  { sheng: "jam", meaning: "stuck/trapped", intent: "being in difficult situation", urgency: 'high', category: 'support' },
  { sheng: "kushinda", meaning: "to defeat/overcome", intent: "being overwhelmed by problems", urgency: 'high', category: 'support' },
  ...
  { sheng: "mchuma", meaning: "gun", intent: "weapon-related danger", urgency: 'high', category: 'legal' },
  { sheng: "bunde", meaning: "a gun", intent: "weapon-related danger", urgency: 'high', category: 'legal' },
  { sheng: "mtoo", meaning: "gun", intent: "weapon-related danger", urgency: 'high', category: 'legal' },
  { sheng: "bundee", meaning: "gun", intent: "weapon-related danger", urgency: 'high', category: 'legal' },
  { sheng: "kidungi", meaning: "a gun", intent: "weapon-related danger", urgency: 'high', category: 'legal' },
  { sheng: "mpini", meaning: "a knife", intent: "weapon-related danger", urgency: 'high', category: 'legal' },
  { sheng: "daga", meaning: "knife, dagger", intent: "weapon-related danger", urgency: 'high', category: 'legal' },
  { sheng: "chanja", meaning: "to stab", intent: "violence or assault", urgency: 'high', category: 'legal' },
  { sheng: "kujam", meaning: "to be angry", intent: "anger management or conflict", urgency: 'high', category: 'mental_health' },
  { sheng: "fyam", meaning: "hectic/problem/crazy situation", intent: "crisis situation", urgency: 'high', category: 'emergency' },
  { sheng: "kumarwa", meaning: "to be beaten", intent: "violence or assault", urgency: 'high', category: 'legal' },
  { sheng: "marwa", meaning: "to be attacked by cops or thugs", intent: "violence or police brutality", urgency: 'high', category: 'legal' },
  { sheng: "samba", meaning: "beat", intent: "violence or assault", urgency: 'high', category: 'legal' },
  { sheng: "twanga", meaning: "to beat", intent: "violence or assault", urgency: 'high', category: 'legal' },
  { sheng: "kusetiwa", meaning: "to be beaten or set up", intent: "violence or betrayal", urgency: 'high', category: 'legal' },
  { sheng: "bash", meaning: "beat", intent: "violence or assault", urgency: 'high', category: 'legal' },
  { sheng: "kunyambisha", meaning: "to shoot using a gun", intent: "gun violence", urgency: 'high', category: 'legal' },
  { sheng: "nyambisha", meaning: "to shoot using a gun", intent: "gun violence", urgency: 'high', category: 'legal' },
