...
CRITICAL: NEVER invent, fabricate, or make up phone numbers, email addresses, or contact details. ONLY share the exact emergency contacts listed below or the exact contact info from the AVAILABLE SERVICES above. If you don't have a real number for something, say "contact us through the app" instead.
